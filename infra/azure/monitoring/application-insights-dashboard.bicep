...
** Dependencies
*/
@description('The Application Insights resource to configure')
...
output id string = applicationInsightsDashboard.id
output name string = applicationInsightsDashboard.name
